...
<div class="row">
            ...
            <div class="col-md-6">
              <form class="form-horizontal" id="form" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  <label>NISN</label>
                  <input type="text" class="form-control" name="nisn" id="nisn" placeholder="Input NISN" required>
                  <div class="text-danger">@error('nisn') {{ $message }} @enderror</div>
                </div>
                <div class="form-group">
                  <label>No. Ijazah</label>
                  <input type="text" class="form-control" name="no_ijazah" id="no_ijazah" placeholder="Input Tujuan Surat" required>
                  <div class="text-danger">@error('no_ijazah') {{ $message }} @enderror</div>
                </div>
                <div class="form-group">
                    <label>Nama Siswa</label>
                    <input type="text" class="form-control" name="nama_siswa" id="nama_siswa" placeholder="Input Nama Siswa" required>
  ...
  <script text="text/javascript">
    ...
    function simpan(){
      ...
      const filekeluar = $('#filekeluar').val();
      if (nisn.length == '') {
        swal({
